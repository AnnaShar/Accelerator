class TextHighlighterQuestion {
    ...
    render() {
        ...
        $(document).ready(function () {
            ...
            $('#' + self.question.id).find('.cf-question__content').before('<div id="th-wrapper__' + self.question.id + '" class="clearfix th-wrapper"><div id="th-question" class="th-highlighter th-sentence">' + text + '</div></div>');
            ...
            $("#th-wrapper__" + self.question.id).prepend(palette);
        ...
        function highlight($elm) {
            debugger;
            var checkHighlighterIsSet = $("#th-question"+$elm.qID).attr("data-highlighter-colors");
